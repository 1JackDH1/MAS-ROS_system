// Environment code for project mAS_ROS.mas2j
...
public class Interface extends Environment {

    private Logger logger = Logger.getLogger("mAS_ROS.mas2j."+Interface.class.getName());
    ...
    public void init(String[] args) {
		...
		pub.publish(new PrimitiveMsg<String>("hello from Jason."));
    }
